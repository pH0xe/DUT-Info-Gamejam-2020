...
while running:
    ...
    for event in pygame.event.get():
        ...
        Text_1_pos = (constant.WIDTH//2-Text_1.get_rect().width//2, 95)
        ...
        Text_2_pos = (constant.WIDTH//2-Text_1.get_rect().width//2, 310)
        ...
        Text_3_pos = (constant.WIDTH//2-Text_1.get_rect().width//2, 410)
        ...
        Text_4_pos = (constant.WIDTH//2-Text_1.get_rect().width//2, 510)
